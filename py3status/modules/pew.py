...
Format placeholders:
    ...
    {body} notification body, eg Cops left. You can come in now.
...
pidgin_notification
[
    {'full_text': 'Dantrell says: ', 'color': '#ff0000'},
    {'full_text': '>_>'},
]
...
class Py3status:
    ...
    def _show_notification(self, bus, notification):
        ...
        self.pew_data = {
            'name': notification[0],
            'summary': self._string_cleanup(notification[3]),
            'body': self._string_cleanup(notification[4]),
        }
        self.py3.update()
